...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            studentsTable.insert(columnsStudentIns, new Student(10, "Roberta Yates", "w", 2));
            ...
            System.out.println("*** Вывод кол-ва студентов ***");
            studentsTable.resultDisplay(studentsTable.selectCountStudents());

            System.out.println("*** Вывод количества студенток ***");
